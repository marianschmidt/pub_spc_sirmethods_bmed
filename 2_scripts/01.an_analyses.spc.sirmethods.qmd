...
supp_fig_byfutime_title <- rlang::englue('Figure S9: Relative risk for SPLC in lung cancer survivors stratified by follow-up time (n={format(nrow(d1_lung_wide), big.mark = ",")}).')
